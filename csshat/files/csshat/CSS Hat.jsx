...
this.getOptions = function() {
  return '<object>' + P(app.version.toString(), 'version') + P($.os.toString(), 'os') + P('a06fd016f3d859b178dc2904f580516e4726ed12e1aca7a283fda0e2099240ac', 'hash') + P('master', 'branch') + P(p, 'debug') + P('stable', 'channel') + '</object>';
};
