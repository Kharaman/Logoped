...
-- Дамп данных таблицы logoped.groups: ~2 rows (приблизительно)
...
-- Дамп данных таблицы logoped.plan_sounds_rel: ~88 rows (приблизительно)
...
-- Дамп данных таблицы logoped.sounds: ~27 rows (приблизительно)
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', NULL, NULL, NULL, NULL, 1268889823, 1463668944, 1, 'Admin', 'istrator', 'ADMIN', '0'),
	(2, '127.0.0.1', 'teacher123', '$2y$08$12r9ZW6EqgqIiP1L5m8VqegMw40YCKcfNkaHlGy3S0WMP2TOn8U.q', NULL, 'kharaman.v@gmail.com', NULL, NULL, NULL, 'RMPgkH5UDDw4SQKVJEbQde', 1463059967, 1463688984, 1, 'Евгения', 'Васильевна', 'ЛП №166', '0'),
...
-- Дамп данных таблицы logoped.work_schedule: ~3 rows (приблизительно)
